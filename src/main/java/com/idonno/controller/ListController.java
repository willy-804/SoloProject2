...
public class ListController {
	...
	@RequestMapping(value = "/to/list_icon2", method = RequestMethod.GET)
	public String list_icon2(Model model, CriteriaVO cri) {
		...
		return "to/list_icon2";
		
	}

	@RequestMapping(value = "/to/list_icon3", method = RequestMethod.GET)
